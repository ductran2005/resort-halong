export const TRANSLATIONS = {
  vi: {
    ...
    story_quote: "“Emerald Da Nang Resort sinh ra từ mong muốn chắt lọc tinh hoa văn hóa Champa cổ kính kết hợp cùng Indochine quý phái, nơi Thượng khách được chăm sóc trọn vẹn, riêng tư và độc bản nhất.”",
    ...
    gallery_album: "Emerald Da Nang Album",
    ...
    book_desc: "Hãy để lại lời nhắn quý báu. Chuyên viên đại sứ phục vụ Thượng khách của Emerald Da Nang Resort sẽ tức tốc ghi nhận, chuẩn bị trà sâm dứa thơm và gọi điện xin tiếp chỉ ý kiến hoàn mỹ trong cuộc điện đàm 10 phút.",
    ...
    footer_copyright: "© 2026 Emerald Da Nang Resort & Heritage Group. Bảo lưu mọi quyền.",
    footer_operator: "Kỳ nghỉ di sản đặc tuyển được khai thác bởi Công ty TNHH Nghỉ Dưỡng Ngọc Lục Bảo Đà Nẵng.",
  ...
  en: {
    ...
    story_quote: "“Emerald Da Nang Resort was born out of a desire to blend ancient Champa culture with elegant Indochine design, where guests enjoy Da Nang in the most private, discreet, and exclusive way.”",
    ...
    book_desc: "Leave your wishes below. Emerald Da Nang Resort's personal guest ambassadors will log your requests, prepare premium tea, and call you back in 10 minutes.",
    ...
    footer_copyright: "© 2026 Emerald Da Nang Resort & Heritage Group. All rights reserved.",
    footer_operator: "Signature itineraries operated by Da Nang Emerald Resort & Villas Co., Ltd.",
